...
export async function main(ns) {
    ...
    let baseName = "auto_serv";
    let multi = 2; // assumes you need up to 4gb for your hack and distro script. you may be able to lower this accordingly.
    let hackScript = "scale_commision.js";
